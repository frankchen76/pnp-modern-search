...
=======
  ...
  private _synonymTable: ISynonymTable;
  private _queryCulture: number;
>>>>>>> 2cbef9bab941f303cbfb6bfa6ca692c8354725aa
    ...
    if (this.refiners) {
      ...
      if (this.refiners) {
        ...
        sortedRefiners = this.refiners.map(e => {
          ...
          const _refinableString = /(RefinableString\d+)/gi;
        ...
        refinementResults = sortBy(refinementResults, (refinement) => {
          ...
          if (e.RelevantResults) {
            ...
            if (secondaryResultBlock.Results.length > 0) {
              ...
              //merge result block to prmotedResults
              secondaryResultBlock.Results.forEach(r => {
                promotedResults.push({
                  Title: r.hasOwnProperty("Title") ? r["Title"] : "",
                  Url: r.hasOwnProperty("Url") ? r["Url"] : "",
                  Description: r.hasOwnProperty("Description") ? r["Description"] : ""
                } as IPromotedResult);
